  ...
  return (
    <div className="container mt-32">
      <div className="grid lg:grid-cols-[66%,34%] gap-4 pr-[15px]">
        <div
          className="h-[200px] md:h-[260px] bg-[url(/product-banner-1.jpg)] bg-cover bg-center rounded-xl p-8 md:p-16"
        >
          ...
          <h2 className="text-topHeadingPrimary font-bold text-xl sm:text-3xl max-w-[240px]">
            coffee beans and grind 2025 Deliver Anywhere
          </h2>
          <a
        ...
        <div
          className="h-[260px] bg-[url(/product-banner-2.jpg)] bg-right rounded-xl hidden lg:block"
        ></div>
      </div>
    </div>
  );
